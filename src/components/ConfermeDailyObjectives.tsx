...
export function ConfermeDailyObjectives({ confermeUserId }: ConfermeDailyObjectivesProps) {
    ...
    if (!data) {
        return (
            <div className="gcard-objective bg-gradient-to-r from-blue-900 to-indigo-900 rounded-xl p-4 animate-pulse">
    ...
    return (
        <div className="gcard-objective bg-gradient-to-r from-blue-900 to-indigo-900 rounded-xl p-4 shadow-lg">
